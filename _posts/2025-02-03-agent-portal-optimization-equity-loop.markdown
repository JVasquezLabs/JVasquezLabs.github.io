...
permalink: /case-studies/agent-portal-optimization/
---
...
- **Smart Deal Submission Forms** — Reduced manual data entry, increasing submission rate by **30%**.
- **Integrated Status Updates & Notifications** — Reduced agent support inquiries by **40%**.
- **A/B Tested UI Changes** — Increased time spent on the portal by **35%**.
