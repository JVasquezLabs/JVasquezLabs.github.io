...
permalink: /case-studies/borrower-self-service/
---
...
- **Self-Service Borrower Portal** — Reduced reliance on customer support by **30%**.
- **Integrated Salesforce & Glia Chatbot** — Allowed customers to track progress **without contacting support**.
- **A/B Tested Checkout Flow Changes** — Improved user engagement and **increased completed appraisals by 20%**.
